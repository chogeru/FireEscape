...
namespace ShinySSRR {
    ...
    public class ShinyScreenSpaceRaytracedReflections : VolumeComponent, IPostProcessComponent {
        ...
        [Obsolete("Moved to the Shiny SSR Render Feature ('Transparency Support'). Will be removed in a future release.")]
        [Tooltip("DEPRECATED. Moved to the Shiny SSR Render Feature.")]
        public BoolParameter transparencySupport = new BoolParameter(false);

        [Obsolete("Moved to the Shiny SSR Render Feature ('Transparency Support Layer Mask' and 'Transparent Normals Layer Mask'). Will be removed in a future release.")]
        [Tooltip("DEPRECATED. Moved to the Shiny SSR Render Feature.")]
        public LayerMaskParameter transparentLayerMask = new LayerMaskParameter(0);

        [Obsolete("Moved to the Shiny SSR Render Feature ('Depth Prepass' under 'Transparency Support'). Will be removed in a future release.")]
        [Tooltip("DEPRECATED. Moved to the Shiny SSR Render Feature.")]
        public BoolParameter transparentDepthPrepass = new BoolParameter(false);

        [Tooltip("Smoothness applied to reflections at transparent pixels driven by the normal prepass. Only used when 'Normal Prepass' is enabled.")]
        public ClampedFloatParameter transparentSmoothness = new ClampedFloatParameter(1f, 0f, 1f);
